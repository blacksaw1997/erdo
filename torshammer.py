...
"""
Tor's Hammer - [TSG] Denial Of Service Saldiri Version 1 home page: https://sourceforge.net/projects/torshammer
...
def usage():
    ...
    print "Ornek: torshammer.py -t 192.168.1.100 -r 800\n\n[TSG] Turk Siber Guvenlik // Alpix\n[TSG] Turk Siber Guvenlik // Alpix\n[TSG] Turk Siber Guvenlik // Alpix\n[TSG] Turk Siber Guvenlik // Alpix"
...
if __name__ == "__main__":
    ...
    print " * Torshammer DDoS Saldiri Versiyon 1.0"
    print " * Alpix Tarafindan Yapilmistir"
    print " * Biz Turk Siber Guvenlik "
    print " * Simdi Saldir!"
    print " \n"

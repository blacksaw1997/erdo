...
def usage():
	print ''' usage : python ssl-attack.py [-t] [-c] http://www.target.com/
	-h : help
	-t : lasting time of ddos
	-c : numbers of bots to create (12000) recommended'''
	sys.exit()
...
if __name__ == '__main__':
	...
	print "Attack Started : bots=%d time=%d %s"%(int(num_thread),int(interval),url)
	if url.count('/') == 2:
		url = url + "/"
